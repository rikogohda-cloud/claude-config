...
| Level | 基準（いずれか1つ該当で該当レベル） |
|-------|------|
| :red_circle: 高 | 与信判断・回収・損失リスクが¥1,000万以上 / 顧客の継続・解約・エスカレーション（1社以上） / 法的・監督当局リスク、契約違反の可能性 / 他チーム・他案件の進行が止まっている |
| :large_orange_diamond: 中 | ¥100万〜¥1,000万未満の判断・調整 / 既存顧客との重要コミュニケーション、条件変更 / チーム運用の変更・新規フロー構築 / メンバーの意思決定フレームワークに影響する指導 |
| :white_circle: 低 | 定型承認・ルーティン確認 / 情報収集・調査（まだアウトプットなし） / 日程調整・軽微な連絡 |
